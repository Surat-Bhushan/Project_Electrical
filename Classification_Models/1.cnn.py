...
# Fully Connected Classification Sub-Network
...
# Output Layer (17 Target Categories)
model.add(keras.layers.Dense(units=17, activation='softmax', use_bias=True))
