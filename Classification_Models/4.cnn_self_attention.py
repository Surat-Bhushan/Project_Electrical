...
# ==========================================
# 4. CNN + SELF ATTENTION ARCHITECTURE
# ==========================================
...
attention_weights = keras.layers.Activation(
    'softmax'
)(attention_weights)

attention_weights = keras.layers.RepeatVector(
    128
)(attention_weights)

attention_weights = keras.layers.Permute(
    [2, 1]
)(attention_weights)

attention_output = keras.layers.multiply(
    [x, attention_weights]
)

attention_pool = keras.layers.GlobalAveragePooling1D()(
    attention_output
)
...
bn_output = keras.layers.BatchNormalization()(
    dense_2
)
